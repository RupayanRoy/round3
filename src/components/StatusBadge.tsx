...
export const StatusBadge = ({ status }: StatusBadgeProps) => {
  const variants: Record<Status, string> = {
    ...
    Congested: "bg-orange-500/10 text-orange-600 hover:bg-orange-500/20 border-orange-200",
    Overloaded: "bg-red-500/10 text-red-600 hover:bg-red-500/20 border-red-200",
  };
